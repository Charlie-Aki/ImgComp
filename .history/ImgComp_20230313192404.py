...
class Application(tkdnd.TkinterDnD.Tk):
    ...
    def create_widgets(self):
        ...
        self.main_frame=MainFrame(master=self, ctrling_frame=self.progress_window_frame)
        self.menubar=Menubar(master=self, ctrling_frame=self.main_frame)
...
class Menubar(tk.Menu):
    def __init__(self, master, ctrling_frame):
        super().__init__(master)
        self.master=master
        self.master.config(menu=self)
        self.controlling_frame=ctrling_frame
    ...
    def clear_all(self):
        # self.master.main_frame.create_widgets.old_entry.delete(0, tk.END)
        # self.master.main_frame.create_widgets.new_entry.delete(0, tk.END)
        # self.master.main_frame.create_widgets.outdir_entry.delete(0, tk.END)
        pass
...
class MainFrame(ttk.Frame):
    def __init__(self, master, ctrling_frame):
        ...
        self.ctrling_frame=ctrling_frame
    ...
    def create_widgets(self):
        ...
        old_clear_button = ttk.Button(self, text="クリア", command=lambda: old_entry.delete(0, tk.END))
        new_clear_button = ttk.Button(self, text="クリア", command=lambda: new_entry.delete(0, tk.END))
        outdir_clear_button = ttk.Button(self, text="クリア", command=lambda: outdir_entry.delete(0, tk.END))
    ...
    def old_entry_dialogue(self):
        ...
        # l_fname1 = []
        # for i_fname1 in range(len(fname1)):
        #     l_fname1.append(fname1[i_fname1].replace("/", os.sep))
        # if fname1:
    ...
    def new_entry_dialogue(self):
        ...
        #        ("tiffファイル", ("*.tif", "*.tiff")),
        #        ("pdfファイル", "*.pdf")]
        # fname2 = filedialog.askopenfilenames(
        #     filetypes=typ, initialdir="", title="改訂図ファイル選択（複数選択可）")
        # l_fname2 = []
        # for i_fname2 in range(len(fname2)):
        #     l_fname2.append(fname2[i_fname2].replace("/", os.sep))
        # if fname2:
