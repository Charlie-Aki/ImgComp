...
class How2UseWindow(tk.Toplevel):
    def __init__(self, master):
        ...
        self.grid_columnconfigure(2, weight=1)
        self.imgs = [
            Image.open(self.master.aida_func.get_abs_path("./imgs/How2Use-1.png")),
            Image.open(self.master.aida_func.get_abs_path("./imgs/How2Use-2.png")),
            Image.open(self.master.aida_func.get_abs_path("./imgs/How2Use-3.png")),
            Image.open(self.master.aida_func.get_abs_path("./imgs/How2Use-4.png")),
            Image.open(self.master.aida_func.get_abs_path("./imgs/How2Use-5.png")),
            Image.open(self.master.aida_func.get_abs_path("./imgs/How2Use-6.png")),
            Image.open(self.master.aida_func.get_abs_path("./imgs/How2Use-7.png")),
            Image.open(self.master.aida_func.get_abs_path("./imgs/How2Use-8.png")),
        ]
