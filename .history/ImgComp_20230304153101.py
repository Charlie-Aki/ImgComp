...
class AboutWindow(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        # self.grid_rowconfigure(0, weight=0)
        # self.grid_rowconfigure(1, weight=0)
        original_icon_img = Image.open(self.icon_file_path)
        original_icon_img = self.original_icon_img.resize((100, 100), Image.ANTIALIAS)
        tk_icon_img = ImageTk.PhotoImage(self.original_icon_img)
