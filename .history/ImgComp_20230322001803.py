...
try:
    import private
    __appname__ = private.__appname__
    __version__ = private.__version__
    __date__    = private.__date__
    __deprecated__ = private.__deprecated__
    __status__ = private.__status__
    __author__ = private.__author__
    __copyright__ = private.__copyright__
    __credits__ = private.__credits__
    __license__ = private.__license__
