...
class Application(tkdnd.TkinterDnD.Tk):
    ...
    def create_widgets(self):
        ...
        self.main_frame=MainFrame(master=self, self.progress_window_frame)
        self.menubar=Menubar(master=self, self.main_frame)
...
class Menubar(tk.Menu):
    def __init__(self, master, controlling_frame):
        super().__init__(master)
        self.master=master
        self.master.config(menu=self)
        self.controlling_frame=controlling_frame
