...
try:
    import hidden
    __appname__ = hidden.__appname__
    __version__ = hidden.__version__
    __date__    = hidden.__date__
    __deprecated__ = hidden.__deprecated__
    __status__ = hidden.__status__
    __author__ = hidden.__author__
    __copyright__ = hidden.__copyright__
    __credits__ = hidden.__credits__
    __license__ = hidden.__license__
