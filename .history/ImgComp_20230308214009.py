...
class Menubar(tk.Menu):
    ...
    def create_edit_menu(self):
        ...
        edit_menu.add_command(label="選択項目をクリア", command=lambda: self.master.focus_get().delete(0, tk.END))
        edit_menu.add_command(label="全項目クリア", command=self.clear_all)

    def clear_all(self):
        self.master.main_frame.create_widgets(self.master).old_entry.delete(0, tk.END)
        self.master.main_frame.create_widgets(self.master).new_entry.delete(0, tk.END)
        self.master.main_frame.create_widgets(self.master).outdir_entry.delete(0, tk.END)
