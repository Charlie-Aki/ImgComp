...
class Application(tkdnd.TkinterDnD.Tk):
    def __init__(self):
        ...
        global model
        model=Model()
        self.icon_image=model.get_abs_path("./imgs/ImgComp_256x256.ico")
    ...
    def create_widgets(self):
        ...
        self.main_frame.reply_menubar(self.menubar)
...
class Menubar(tk.Menu):
    ...
    def create_file_menu(self):
        ...
        file_menu.add_command(label="実行", command=self.ctrl_frame.run_program)
        file_menu.add_command(label="中断", command=self.ctrl_frame.stop_program)
...
class MainFrame(ttk.Frame):
    ...
    def run_program(self):
        try:
            ...
            thread_main = threading.Thread(target=self.img_comp_flow(fname1=fname1, fname2=fname2, output_dir=output_dir))
    ...
    def img_comp_flow(self, fname1, fname2, output_dir):
        ...
        for j in range(len(fname1)):
            if self.thread_flag.is_set() == True:
                ...
                #画像バイナリデータの読み込み
                drw1, drw2, num_frames, dpi_value = model.read_binary_image(fname1[j], fname2[j])
...
class How2UseWindow(tk.Toplevel):
    def __init__(self, master):
        ...
        model=Model()
        self.imgs = [
            Image.open(model.get_abs_path("./imgs/How2Use-1.png")),
            Image.open(model.get_abs_path("./imgs/How2Use-2.png")),
            Image.open(model.get_abs_path("./imgs/How2Use-3.png")),
            Image.open(model.get_abs_path("./imgs/How2Use-4.png")),
            Image.open(model.get_abs_path("./imgs/How2Use-5.png")),
            Image.open(model.get_abs_path("./imgs/How2Use-6.png")),
            Image.open(model.get_abs_path("./imgs/How2Use-7.png")),
            Image.open(model.get_abs_path("./imgs/How2Use-8.png")),
        ]
