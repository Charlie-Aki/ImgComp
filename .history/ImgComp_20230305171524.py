...
class AboutWindow(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        logo_img = Image.open(aida_func.get_abs_path("./imgs/nuntara.png"))
        logo_img = logo_img.resize((50, 50), Image.LANCZOS)
        tk_logo_img = ImageTk.PhotoImage(logo_img)

        icon_label = ttk.Label(self, image=tk_logo_img, anchor='e', background='red')
        ...
        icon_label.grid(row=0, column=0, padx=100, pady=100, sticky="NSEW")
