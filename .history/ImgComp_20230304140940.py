...
class How2UseWindow(tk.Toplevel):
    ...
    def resize_image(self, event, image_number):
        ...
        self.img[image_number] = self.copy_of_image[image_number].resize(
            (new_width, new_height))
        self.how2_img[image_number] = ImageTk.PhotoImage(
            self.img[image_number])
        self.img_label.config(image=self.how2_img[image_number])
        # avoid garbage collection
        self.img_label.image = self.how2_img[image_number]
