...
class Menubar(tk.Menu):
    ...
    def clear_all(self):
        self.ctrl_frame.create_widgets.self.old_entry.delete(0, tk.END)
        self.ctrl_frame.create_widgets.self.new_entry.delete(0, tk.END)
        self.ctrl_frame.create_widgets.self.outdir_entry.delete(0, tk.END)
...
class MainFrame(ttk.Frame):
    ...
    def old_entry_dialogue(self):
        ...
        # if fname1:
        #     self.self.old_entry.delete(0, tk.END)
        #     self.self.old_entry.insert(0, ','.join(l_fname1))
    ...
    def new_entry_dialogue(self):
        ...
        # if fname2:
        #     self.self.new_entry.delete(0, tk.END)
        #     self.self.new_entry.insert(0, ','.join(l_fname2))
    ...
    def outdir_entry_dialogue(self):
        ...
        # if output_dir:
        #     self.self.outdir_entry.delete(0, tk.END)
        #     self.self.outdir_entry.insert(0, output_dir)
