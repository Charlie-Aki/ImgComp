...
class MainFrame(ttk.Frame):
    ...
    def run_program(self):
        try:
            ...
            thread_main = threading.Thread(target=self.img_comp_flow, args=(fname1=fname1, fname2=fname2, output_dir=output_dir, ))
...
class Model:
    ...
    def read_binary_image(self, fname1, fname2):
        ...
        print("ここまできたかread_binary_image 1")
        if file_exts[0].endswith(".tif") or file_exts[0].endswith(".tiff"):
            print("ここまできたかread_binary_image 2")
            ...
            print("ここまできたかread_binary_image 3")
