...
class Menubar(tk.Menu):
    ...
    def create_edit_menu(self):
        ...
        edit_menu.add_command(label="選択項目をクリア", command=self.master.focus_get().delete(0, tk.END))
        edit_menu.add_command(label="全項目クリア", command=self.clear_all)

    def clear_all(self):
        self.ctrl_frame.create_widgets.old_entry.delete(0, tk.END)
        self.ctrl_frame.create_widgets.new_entry.delete(0, tk.END)
        self.ctrl_frame.create_widgets.outdir_entry.delete(0, tk.END)
